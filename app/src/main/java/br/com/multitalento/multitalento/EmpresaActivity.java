...
public class EmpresaActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Perfil Empresa");
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.perfil) {
            Intent it = new Intent(EmpresaActivity.this, PerfilActivity.class);
            startActivity(it);
        } else if (id == R.id.nav_home) {
            Intent it = new Intent(EmpresaActivity.this, HomeActivity.class);
            startActivity(it);

        } else if (id == R.id.desafios) {
            Intent it = new Intent(EmpresaActivity.this, DesafiosActivity.class);
            startActivity(it);

        } else if (id == R.id.hackatons) {
            Intent it = new Intent(EmpresaActivity.this, FoodList.class);
            startActivity(it);

        } else if (id == R.id.parceiros) {
            Intent it = new Intent(EmpresaActivity.this, EmpresaActivity.class);
            startActivity(it);
    ...
    public void cadastro(View view) {
        Intent it = new Intent(EmpresaActivity.this, MainActivity.class);
        startActivity(it);
    }
}
